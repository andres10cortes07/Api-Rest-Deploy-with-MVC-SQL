DROP DATABASE IF EXISTS peliculasBD;
...
CREATE TABLE pelicula (
    ...
    rate DOUBLE (2,1) UNSIGNED NOT NULL
);
...
CREATE TABLE movie_genres (
	movie_id BINARY (16) REFERENCES pelicula(id),
...
(
    (SELECT id FROM pelicula WHERE title = 'The Shawshank Redemption'),
    (SELECT id FROM genre WHERE name = 'Drama')
),
(
    (SELECT id FROM pelicula WHERE title = 'The Dark Knight'),
...
(
    (SELECT id FROM pelicula WHERE title = 'Inception'),
    (SELECT id FROM genre WHERE name = 'Action')
),
(
    (SELECT id FROM pelicula WHERE title = 'Inception'),
...
-- Insertar para más películas y géneros según sea necesario
(
    (SELECT id FROM pelicula WHERE title = 'Pulp Fiction'),
    (SELECT id FROM genre WHERE name = 'Crime')
),
(
    (SELECT id FROM pelicula WHERE title = 'Pulp Fiction'),
...
(
    (SELECT id FROM pelicula WHERE title = 'Forrest Gump'),
    (SELECT id FROM genre WHERE name = 'Drama')
),
(
    (SELECT id FROM pelicula WHERE title = 'Forrest Gump'),
...
(
    (SELECT id FROM pelicula WHERE title = 'Gladiator'),
    (SELECT id FROM genre WHERE name = 'Action')
),
(
    (SELECT id FROM pelicula WHERE title = 'Gladiator'),
...
-- Continuar con todas las películas y géneros del JSON
(
    (SELECT id FROM pelicula WHERE title = 'The Matrix'),
    (SELECT id FROM genre WHERE name = 'Action')
),
(
    (SELECT id FROM pelicula WHERE title = 'The Matrix'),
...
(
    (SELECT id FROM pelicula WHERE title = 'Interstellar'),
    (SELECT id FROM genre WHERE name = 'Adventure')
),
(
    (SELECT id FROM pelicula WHERE title = 'Interstellar'),
...
(
    (SELECT id FROM pelicula WHERE title = 'The Lord of the Rings: The Return of the King'),
    (SELECT id FROM genre WHERE name = 'Action')
),
(
    (SELECT id FROM pelicula WHERE title = 'The Lord of the Rings: The Return of the King'),
...
(
    (SELECT id FROM pelicula WHERE title = 'The Lion King'),
...
(
    (SELECT id FROM pelicula WHERE title = 'The Avengers'),
    (SELECT id FROM genre WHERE name = 'Action')
),
(
    (SELECT id FROM pelicula WHERE title = 'The Avengers'),
...
(
    (SELECT id FROM pelicula WHERE title = 'Jurassic Park'),
    (SELECT id FROM genre WHERE name = 'Adventure')
),
(
    (SELECT id FROM pelicula WHERE title = 'Jurassic Park'),
...
(
    (SELECT id FROM pelicula WHERE title = 'Titanic'),
    (SELECT id FROM genre WHERE name = 'Drama')
),
(
    (SELECT id FROM pelicula WHERE title = 'Titanic'),
...
(
    (SELECT id FROM pelicula WHERE title = 'The Social Network'),
...
(
    (SELECT id FROM pelicula WHERE title = 'Avatar'),
    (SELECT id FROM genre WHERE name = 'Action')
),
(
    (SELECT id FROM pelicula WHERE title = 'Avatar'),
